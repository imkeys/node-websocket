...
/* 
 ...
 $.scrollTo(y, s)
 */
(function(){$.extend({getHash:function(){var hash=window.location.hash;var r=hash.substr(1,hash.length-1);if(r){return r}else{return null}},getParam:function(string){var reg=new RegExp("(^|&)"+string+"=([^&]*)(&|$)");var r=window.location.search.substr(1).match(reg);if(r!=null){return unescape(r[2])}else{return null}},scrollTo:function(y,s){$('html, body').stop().animate({'scrollTop':y||0},s||300)}})})(jQuery);


/* 
	禁止右键以及F12
 */
$(document).keydown(function(e){if(e.ctrlKey==true&&e.keyCode==83){return true}if(e.keyCode==123){return true}}).ready(function(){$(document).bind("contextmenu",function(e){return true})});